...
public static class Prompts
{
    ...
    public static readonly string PromptEnding = $$"""
        Only use these tags {{FormatList(AllowedTags)}}, and these attributes {{FormatList(AllowedAttributes)}}.
    ...
    public static readonly string OcrLayoutPrompt = $$"""
    ...
    public static readonly IReadOnlyDictionary<string, string> PromptMapping = new Dictionary<string, string>
    {
        ["ocr_layout"] = OcrLayoutPrompt,
        ["ocr"] = OcrPrompt,
    };
}
